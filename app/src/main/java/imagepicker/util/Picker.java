...
public final class Picker {
    ...
    public static class Builder {
        ...
        private int mLimit = PickerActivity.NO_LIMIT;//默认是没有数量限制的
        ...
        public Builder(final Context context, final PickListener listener) {
            ...
            mContext = context;
            mContext.setTheme(mThemeResId);//theme是给activity设置的
        ...
        private void init() {
            ...
            mFabBackgroundColorWhenPressed = ColorUtils.setAlphaComponent(mFabBackgroundColor, (int) (Color.alpha(mFabBackgroundColor) * 0.8f));
